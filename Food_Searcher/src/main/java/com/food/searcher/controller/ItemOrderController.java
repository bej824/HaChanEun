...
public class ItemOrderController {
	...
	public ResponseEntity<Integer> cancel(@PathVariable("orderId") String orderId, @RequestBody Map<String, String> deliveryStatusMap) {
	...
	public ResponseEntity<Integer> refundReady(@PathVariable("orderId") String orderId, @RequestBody Map<String, String> deliveryStatusMap) {
	    String deliveryStatus = deliveryStatusMap.get("deliveryStatus");
	...
	public ResponseEntity<Integer> refundOK(@PathVariable("orderId") String orderId, @RequestBody Map<String, String> deliveryStatusMap) {
	    String deliveryStatus = deliveryStatusMap.get("deliveryStatus");
	...
	public ResponseEntity<Integer> delivering(@PathVariable("orderId") String orderId, @RequestBody Map<String, String> deliveryStatusMap) {
	    String deliveryStatus = deliveryStatusMap.get("deliveryStatus");
	...
	public ResponseEntity<Integer> completed(@PathVariable("orderId") String orderId, @RequestBody Map<String, String> deliveryStatusMap) {
	    String deliveryStatus = deliveryStatusMap.get("deliveryStatus");
	    return new ResponseEntity<Integer>(directOrderService.deliveryCompleted(deliveryStatus, orderId), HttpStatus.OK);
	}
}
